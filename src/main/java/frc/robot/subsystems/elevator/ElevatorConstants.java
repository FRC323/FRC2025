...
public class ElevatorConstants {
  ...
  public static int bottomLimitSwitchChannel = 0;
  ...
  public static double maxVelocity = 5; // 25.66;
  public static double maxAcceleration = 10; // 51.32;
  ...
  public static double maxElevatorHeight = 60;
}
