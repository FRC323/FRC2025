...
public class Drive extends SubsystemBase {
  ...
  private final Field2d simulationField = new Field2d();
  ...
  public Drive(
    ...
    this.gyroIO = gyroIO;
    // have vision now, so we don't need to zero gyro
  ...
  public void periodic() {
    ...
    if (VisionConstants.show2dField) {
      simulationField.setRobotPose(getPose());
    }
    ...
    for (int i = 0; i < sampleCount; i++) {
      ...
      SmartDashboard.putNumber("Drive.GetPose.Y", poseEstimator.getEstimatedPosition().getY());
