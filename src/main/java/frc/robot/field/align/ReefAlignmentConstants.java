...
public final class ReefAlignmentConstants {
  ...
  // robot width / 2
  public static final double outwardOffsetFromTag = 0.50;
  ...
  public static final HashMap<Integer, ReefPoleOffset> tagToPoleOffset =
      // .205 = right branch at home
      new HashMap<>() {
        {
          put(17, new ReefPoleOffset(.175, .260)); // blue
          put(18, new ReefPoleOffset(.175, .260));
          put(19, new ReefPoleOffset(.175, .260));
          put(20, new ReefPoleOffset(.175, .260));
          put(21, new ReefPoleOffset(.175, .260));
          put(22, new ReefPoleOffset(.175, .260));

          put(6, new ReefPoleOffset(.175, .260)); // red
          put(7, new ReefPoleOffset(.175, .260));
          put(8, new ReefPoleOffset(.175, .260));
          put(9, new ReefPoleOffset(.175, .260));
          put(10, new ReefPoleOffset(.175, .260));
          put(11, new ReefPoleOffset(.175, .260));
        }
      };
